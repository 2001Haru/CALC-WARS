...
#### 这份README文件是关于CALC WARS项目的代码说明文件，应该会位于与CALC WARS主文件夹同一目录下。
...
#### Model_checkpoints: 模型历史检查点储存文件。我们为游戏不同AI难度接入了不同阶段检查点文件，如果您想尝试其他检查点模型性能，您也可以在CALC_WARS.py主文件中修改文件路径。
...
#### This README provides technical documentation for the CALC WARS project and should be located in the same directory as the main CALC WARS folder.
