...
class TrainingManager:
    ...
    def collect_episode(self) -> float:
        ...
        while not done and steps < self.config.get('max_episode_steps', 200):
            # 获取当前玩家ID
