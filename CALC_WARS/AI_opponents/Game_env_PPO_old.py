...
class Game:
    ...
    def _get_state(self):
        ...
        damage_weights = [5.0] + [3.0]*2 + [1.0]*4  # 与zones_7对应
        state_vector[72:79] = np.array(damage_weights,dtype=np.float32) / 5.0
