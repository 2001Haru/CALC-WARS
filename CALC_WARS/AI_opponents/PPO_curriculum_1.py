import torch
import numpy as np
from PPO_ver7_experiment_1 import TrainingManager, config as base_config
from Env_exp_1 import Game
...
if __name__ == "__main__":
    ...
    phase2_config.update({
        ...
        'entropy_min': 0.005,    # 最低值也提高
        
        # 其他可调参数
        'clip_param': 0.25,      # 保持或略降
        'value_coef': 0.60,       # 提高价值损失权重，稳定训练
    ...
    load_and_continue_training(
        pretrained_path='ppo_6000_1.pth',
